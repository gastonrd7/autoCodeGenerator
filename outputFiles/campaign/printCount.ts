...
{
    constructor(){
        super(globalModels.Model.campaign, globalModels.campaignFields.printCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {          
            ...
            await request.init(globalModels.Model.advertisement, null, 
                {[globalModels.advertisementFields.campaignId]: msgPayload[globalModels.advertisementFields.campaignId]},
                 null, null, null, null, globalModels.advertisementFields.printCount);
        ...
        {
            return Promise.reject("Error in campaign printCount. Error: " + JSON.stringify(err));
        }
    }    
}
