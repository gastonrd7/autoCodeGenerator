...
{
    constructor(){
        super(globalModels.Model.campaign, globalModels.campaignFields.budgetSpent, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in campaign budgetSpent. Error: " + JSON.stringify(err));
        }
    }    
}
