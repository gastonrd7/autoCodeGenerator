...
{
    constructor(){
        super("_onCreation_fill_extra_fields", globalModels.Model.campaign);
    }
    ...
    async resolvenewValue(msgPayload: any): Promise<{ proceed: boolean; newValues: any; }> {
        ...
        {
            return Promise.reject("Error in campaign _onCreation_fill_extra_fields. Error: " + JSON.stringify(err));
        }
    }    
}
