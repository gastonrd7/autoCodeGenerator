...
{
    constructor(){
        super(globalModels.Model.campaign, globalModels.campaignFields.sharedCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {          
            ...
            await request.init(globalModels.Model.advertisement, null, 
                {[globalModels.advertisementFields.campaignId]: msgPayload[globalModels.advertisementFields.campaignId]},
                 null, null, null, null, globalModels.advertisementFields.sharedCount);
        ...
        {
            return Promise.reject("Error in campaign sharedCount. Error: " + JSON.stringify(err));
        }
    }    
}
