...
{
    constructor(){
        super(globalModels.Model.campaign, globalModels.campaignFields.linkCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {          
            ...
            await request.init(globalModels.Model.advertisement, null, 
                {[globalModels.advertisementFields.campaignId]: msgPayload[globalModels.advertisementFields.campaignId]},
                 null, null, null, null, globalModels.advertisementFields.linkCount);
        ...
        {
            return Promise.reject("Error in campaign linkCount. Error: " + JSON.stringify(err));
        }
    }    
}
