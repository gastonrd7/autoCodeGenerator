...
{
    constructor(){
        super(globalModels.Model.campaign, globalModels.campaignFields.hashtagCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {          
            ...
            await request.init(globalModels.Model.advertisement, null, 
                {[globalModels.advertisementFields.campaignId]: msgPayload[globalModels.advertisementFields.campaignId]},
                 null, null, null, null, globalModels.advertisementFields.hashtagCount);
        ...
        {
            return Promise.reject("Error in campaign hashtagCount. Error: " + JSON.stringify(err));
        }
    }    
}
