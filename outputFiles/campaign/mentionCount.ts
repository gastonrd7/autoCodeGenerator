...
{
    constructor(){
        super(globalModels.Model.campaign, globalModels.campaignFields.mentionCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {          
            ...
            await request.init(globalModels.Model.advertisement, null, 
                {[globalModels.advertisementFields.campaignId]: msgPayload[globalModels.advertisementFields.campaignId]},
                 null, null, null, null, globalModels.advertisementFields.mentionCount);
        ...
        {
            return Promise.reject("Error in campaign mentionCount. Error: " + JSON.stringify(err));
        }
    }    
}
