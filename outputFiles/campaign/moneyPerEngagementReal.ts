...
{
    constructor(){
        super(globalModels.Model.campaign, globalModels.campaignFields.moneyPerEngagementReal, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in campaign moneyPerEngagementReal. Error: " + JSON.stringify(err));
        }
    }    
}
