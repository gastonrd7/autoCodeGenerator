...
{
    constructor(){
        super(globalModels.Model.campaign, globalModels.campaignFields.commentCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {          
            ...
            await request.init(globalModels.Model.advertisement, null, 
                {[globalModels.advertisementFields.campaignId]: msgPayload[globalModels.advertisementFields.campaignId]},
                 null, null, null, null, globalModels.advertisementFields.commentCount);
        ...
        {
            return Promise.reject("Error in campaign commentCount. Error: " + JSON.stringify(err));
        }
    }    
}
