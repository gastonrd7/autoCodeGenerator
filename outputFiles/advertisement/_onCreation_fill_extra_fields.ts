...
{
    constructor(){
        super("_onCreation_fill_extra_fields", globalModels.Model.advertisement);
    }
    ...
    async resolvenewValue(msgPayload: any): Promise<{ proceed: boolean; newValues: any; }> {
        ...
        {
            return Promise.reject("Error in advertisement _onCreation_fill_extra_fields. Error: " + JSON.stringify(err));
        }
    }    
}
