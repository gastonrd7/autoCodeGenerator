...
export default class budgetSpent extends abstractFieldHandler
{
    constructor(){
        super(globalModels.Model.company, globalModels.companyFields.budgetSpent, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in company budgetSpent. Error: " + JSON.stringify(err));
        }
    }    
}
