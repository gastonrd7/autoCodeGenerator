...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.notSponsoredLikeCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post notSponsoredLikeCount. Error: " + JSON.stringify(err));
        }
    }    
}
