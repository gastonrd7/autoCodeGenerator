...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.instagramLinkCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post instagramLinkCount. Error: " + JSON.stringify(err));
        }
    }    
}
