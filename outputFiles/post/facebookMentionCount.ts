...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.facebookMentionCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post facebookMentionCount. Error: " + JSON.stringify(err));
        }
    }    
}
