...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.facebookLinkCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post facebookLinkCount. Error: " + JSON.stringify(err));
        }
    }    
}
