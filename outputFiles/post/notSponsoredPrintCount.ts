...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.notSponsoredPrintCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post notSponsoredPrintCount. Error: " + JSON.stringify(err));
        }
    }    
}
