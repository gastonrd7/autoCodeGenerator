...
export default class twitterCommentCount extends abstractFieldHandler
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.twitterCommentCount, null);
    }
    async subcribeEvents(){
        ...
        await messagingService.subscribe(this.name, await eventFormater.formatEvent(globalModels.Model.insight, globalEvents.Event.CREATED), function(err, msg){
            var hand = new twitterCommentCount();
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {          
            ...
            if (msgPayload[globalModels.insightFields.platform] != globalModels.insightPlatformEnum.Twitter) return Promise.resolve({proceed: false, newValue: null});
            ...
            await request.init(globalModels.Model.insight, [globalModels.insightFields.creationDt], 
            {
                ...
                [globalModels.insightFields.platform]: globalModels.insightPlatformEnum.Twitter
            }, 
        ...
        {
            return Promise.reject("Error in post twitterCommentCount. Error: " + JSON.stringify(err));
        }
    }    
}
