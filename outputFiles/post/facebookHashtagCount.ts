...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.facebookHashtagCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post facebookHashtagCount. Error: " + JSON.stringify(err));
        }
    }    
}
