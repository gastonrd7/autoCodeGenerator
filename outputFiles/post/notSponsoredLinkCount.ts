...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.notSponsoredLinkCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post notSponsoredLinkCount. Error: " + JSON.stringify(err));
        }
    }    
}
