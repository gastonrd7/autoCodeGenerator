...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.facebookCommentCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post facebookCommentCount. Error: " + JSON.stringify(err));
        }
    }    
}
