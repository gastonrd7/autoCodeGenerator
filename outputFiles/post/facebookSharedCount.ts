...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.facebookSharedCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post facebookSharedCount. Error: " + JSON.stringify(err));
        }
    }    
}
