...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.notSponsoredHashtagCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post notSponsoredHashtagCount. Error: " + JSON.stringify(err));
        }
    }    
}
