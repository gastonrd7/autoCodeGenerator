...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.twitterLikeCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post twitterLikeCount. Error: " + JSON.stringify(err));
        }
    }    
}
