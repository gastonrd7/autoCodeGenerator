...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.instagramLikeCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post instagramLikeCount. Error: " + JSON.stringify(err));
        }
    }    
}
