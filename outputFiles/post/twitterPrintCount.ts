...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.twitterPrintCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post twitterPrintCount. Error: " + JSON.stringify(err));
        }
    }    
}
