...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.facebookTagCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post facebookTagCount. Error: " + JSON.stringify(err));
        }
    }    
}
