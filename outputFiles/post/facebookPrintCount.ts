...
{
    constructor(){
        super(globalModels.Model.post, globalModels.postFields.facebookPrintCount, null);
    }
    ...
    async resolveScalar(msgPayload): Promise<{proceed, newValue}> {
        ...
        {
            return Promise.reject("Error in post facebookPrintCount. Error: " + JSON.stringify(err));
        }
    }    
}
